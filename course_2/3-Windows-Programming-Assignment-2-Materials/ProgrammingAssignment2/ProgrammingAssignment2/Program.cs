...
namespace ProgrammingAssignment2
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            double mean = 0; // to store the mean of the value
            int count = 0; // to store the count of items processed
            int sum = 0; // to store the sum of whatever 
            while (input[0] != 'q')
            {
                ...
                if (x != -1)
                {
                    ...
                    while ((x = GetValue()) != -1) // that is reaching end of the linked list
                    {
                        sum += x;
                        count++;
                    }
